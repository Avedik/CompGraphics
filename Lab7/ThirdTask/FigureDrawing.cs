...
namespace ThirdTask
{
    public partial class Form1
    {
        ...
        private void buttonShape_Click(object sender, EventArgs e)
        {
            ...
            {
                currentShape = ShapeGetter.getSurface(
                    double.Parse(textXStart.Text), double.Parse(textYStart.Text), 
                    double.Parse(textXEnd.Text), double.Parse(textYEnd.Text), 
                    int.Parse(textSteps.Text),
                    double.Parse(textCX.Text), double.Parse(textCY.Text),
                    double.Parse(textFT.Text));
                redraw();
                setFlags(true);
            }
