    ...
    public partial class Form1 : Form
    {
        ...
        void setFlags(bool interactiveMode = false)
        {
            isInteractiveMode = selectAxis.Enabled = selectPlane.Enabled = 
                ...
                textAngleForLineRotation.Enabled = textBoxAngleRotCenter.Enabled =
                buttonSave.Enabled = interactiveMode;

            textCX.Enabled = textCY.Enabled = textFT.Enabled =
            textXStart.Enabled = textYStart.Enabled = 
            textXEnd.Enabled = textYEnd.Enabled =
            textSteps.Enabled = !interactiveMode;
